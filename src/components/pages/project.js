import { parce, v4 as uuidv4 } from "uuid"
                ...
                <div className={styles.project_details}>
                    ...
                    <div className={styles.details_container}>
                        ...
                        {!showProjectForm ? (
                            ...
                            <div className={styles.project_info}>
                                <ProjetoForm handleSubmit={editPost} btnText="Concluir edição" projectData={project}></ProjetoForm>
                            </div>
                        )
                    ...
                    <div>
                        {services.length > 0 &&
                            services.map((service) => (
                                <ServiceCard id={service.id} name={service.name} cost={service.cost} description={service.description} key={service.id} handleRemove={removeService}></ServiceCard>
                            ))
                        }
